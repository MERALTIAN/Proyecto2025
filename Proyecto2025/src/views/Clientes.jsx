...
const Clientes = () => {
  ...
  const cargarClientes = async () => {
    try {
      ...
      console.log("[DEBUG] cargarClientes -> data:", data);
      setClientes(data || []);
    } catch (err) {
    ...
    <Container className="mt-3">
      ...
      <Row className="mb-4 align-items-center">
        ...
        <Col xs={12} md={5} lg={6} className="text-md-end">
          <Button variant="success" onClick={() => setMostrarModal(true)} size="md">
      ...
      <NotificacionOperacion
        visible={toast.mostrar}
        setVisible={(visible) => setToast((prev) => ({ ...prev, mostrar: visible }))}
