...
const TablaVentas = ({ ventas, abrirEdicion, abrirModalEliminacion }) => {
  return (
        ...
        {ventas.map((venta) => (
          <tr key={venta.id_venta}>
            ...
            <td className="text-center">
              <Button variant="outline-warning" size="sm" className="me-1" onClick={() => abrirEdicion(venta)}>
                <i className="bi bi-pencil"></i>
              </Button>
              <Button variant="outline-danger" size="sm" onClick={() => abrirModalEliminacion(venta)}>
